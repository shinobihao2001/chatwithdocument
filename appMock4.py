...
.ocr-panel div[data-testid="stVerticalBlock"] {
...
with st.container():
    ...
    with right_col:
        ...
        with tab_ocr:
            ...
            st.markdown('<div class="ocr-panel">', unsafe_allow_html=True)
